...
# Helper Functions
# ----------------------------
def drive_forward_with_correction(power=-30, duration=0.5): 
...
def subsystem_test():
    ...
    while not stop_signal:
        drive_forward_with_correction(power=-30, duration=0.5) #we can change here
    ...
    while not stop_signal:
        drive_forward_with_correction(power=-30, duration=0.4)
        front_distance = ULTRASONIC_SENSOR.get_cm()
